...
Partial Class Step3
    ...
    Private Sub InitializeComponent()
        ...
        Me.KnightButton1 = New InstallerSetup.Controls.KnightTheme.KnightButton()
        Me.InstallationDirtextbox = New InstallerSetup.Controls.XylosThemeMod.XylosTextBox()
        Me.LogInLabel2 = New InstallerSetup.Controls.LogInLabelTheme.LogInLabel()
        Me.RichTextLabel1 = New InstallerSetup.Controls.CustomRichTextLabel.RichTextLabel()
    ...
    Friend WithEvents RichTextLabel1 As InstallerSetup.Controls.CustomRichTextLabel.RichTextLabel
    Friend WithEvents LogInLabel2 As InstallerSetup.Controls.LogInLabelTheme.LogInLabel
    Friend WithEvents InstallationDirtextbox As InstallerSetup.Controls.XylosThemeMod.XylosTextBox
    Friend WithEvents KnightButton1 As InstallerSetup.Controls.KnightTheme.KnightButton
